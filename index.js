...
var Gmail = function(localJQuery) {
  ...
  */
        ...
        handler: function(match, callback) {
          ...
          if (match.is_inline()) {
            ...
            composeWindow.find('.Ha').mouseup(function() {
                var _event = new window.CustomEvent('gmail_close_compose_window', {detail: {match: match}});
  ...
  api.tools.remove_modal_window = function() {
    ...
    api.tools.add_modal_window_one_button = function(title, content_html, onClickOk, onClickCancel, onClickClose) {
